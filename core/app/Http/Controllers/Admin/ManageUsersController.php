...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $data['milestoneFunded'] = $user->milestones->where('payment_status', Status::MILESTONE_FUNDED)->sum('amount');
        ...
        return view('admin.users.detail', compact('pageTitle', 'data', 'user', 'totalDeposit', 'totalWithdrawals', 'totalTransaction', 'countries'));
    }
