...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(Listing::class)->where('status', Status::LISTING_ACTIVE);
    }

    public function soldListings()
    {
        return $this->hasMany(Listing::class)->where('status', Status::LISTING_SOLD);
    }
    ...
    {
        return $this->hasMany(Bid::class)->where('status', Status::BID_WON);
    }
    ...
    {
        return $this->belongsToMany(Listing::class, 'watchlist')->withTimestamps();
    }
