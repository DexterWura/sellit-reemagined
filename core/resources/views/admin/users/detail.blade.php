        ...
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.report.transaction', $user->id) }}" title="Balance" icon="las la-money-bill-wave-alt"
                        value="{{ showAmount($user->balance) }}" bg="indigo" type="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.deposit.list', $user->id) }}" title="Deposits" icon="las la-wallet"
                        value="{{ showAmount($totalDeposit) }}" bg="8" type="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.withdraw.data.all', $user->id) }}" title="Withdrawals" icon="la la-bank"
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.report.transaction', $user->id) }}" title="Transactions" icon="las la-exchange-alt"
                        value="{{ $totalTransaction }}" bg="17" type="2" />
                </div>
                <div class="row gy-4 mt-2">
                    <div class="col-xxl-3 col-sm-6">
                        <x-widget link="javascript:void(0)" style="6" color="primary" icon="la la-hand-holding-usd" title="Milestone Funded"
                            value="{{ showAmount($data['milestoneFunded']) }}" icon_style="solid" overlay_icon="0" :viewMoreIcon=false :outline=true />
                    </div>

                    <div class="col-xxl-3 col-sm-6">
                        <x-widget link="javascript:void(0)" style="6" bg="info" icon="la las la-handshake" title="Total Escrow" value="{{ $data['totalEscrow'] }}"
                            icon_style="solid" overlay_icon="0" :viewMoreIcon=false :outline=true  />
                    </div>

                    <div class="col-xxl-3 col-sm-6">
                        <x-widget link="javascript:void(0)" style="6" icon="las la-running" color="success" title="Running Escrow" value="{{ $data['accepted'] }}"
                            icon_style="solid" overlay_icon="0" :viewMoreIcon=false :outline=true  />
                    </div>

                    <div class="col-xxl-3 col-sm-6">
                        <x-widget link="javascript:void(0)" style="6" bg="warning" icon="la la-spinner" title="Awaiting for Accept" value="{{ $data['notAccepted'] }}"
                            icon_style="solid" overlay_icon="0" :viewMoreIcon=false :outline=true  />
                    </div>
                </div><!-- row end-->
                ...
                <div class="row gy-4 mt-2">
                    <div class="col-xxl-3 col-sm-6">
                        <x-widget style="6" bg="success" icon="la la-check" title="Completed Escrow" value="{{ $data['completed'] }}"
                            icon_style="solid" overlay_icon="0" :viewMoreIcon=false :outline=true />
                    </div>
                    <div class="col-xxl-3 col-sm-6">
                        <x-widget style="6" bg="warning" icon="las la-ban" title="Disputed Escrow" value="{{ $data['disputed'] }}"
                            icon_style="solid" overlay_icon="0" :viewMoreIcon=false :outline=true />
                    </div>
                    <div class="col-xxl-3 col-sm-6">
                    ...
                    <div class="col-xxl-3 col-sm-6">
                        <x-widget style="6" color="6" icon="la la-ticket-alt" title="Total Ticket" value="{{ $data['ticket'] }}"
                            icon_style="solid" overlay_icon="0" :viewMoreIcon=false :outline=true />
                    </div>
                </div><!-- row end-->
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                <div class="flex-fill">
                    <button data-bs-toggle="modal" data-bs-target="#addSubModal" class="btn btn--success btn--shadow w-100 btn-lg bal-btn"
                        data-act="add">
                ...
                <div class="flex-fill">
                    <button data-bs-toggle="modal" data-bs-target="#addSubModal" class="btn btn--danger btn--shadow w-100 btn-lg bal-btn"
                        data-act="sub">
