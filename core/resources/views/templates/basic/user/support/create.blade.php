                        ...
                        <form action="{{route('ticket.store')}}" class="disableSubmission" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    <textarea name="message" id="inputMessage" rows="4"
                                ...
                                <div class="col-md-9">
                                    ...
                                    <p class="mb-2"><span class="text--info">@lang('Max 5 files can be uploaded |
                                            Maximum upload size is
                                            '.convertToReadableSize(ini_get('upload_max_filesize')) .' | Allowed File
