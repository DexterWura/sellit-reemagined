...
--
-- Host: localhost:3306
-- Generation Time: Dec 01, 2025 at 01:14 PM
...
(555, 'marketplace_hero.content', '{\"heading\":\"Buy & Sell Online Businesses\",\"subheading\":\"The trusted marketplace for domains, websites, apps, and social media accounts\",\"button_text\":\"Browse Marketplace\",\"button_url\":\"/marketplace\",\"status\":\"1\"}', NULL, 'basic', '', NOW(), NOW()),
(556, 'marketplace_featured.content', '{\"heading\":\"Featured Listings\",\"subheading\":\"Hand-picked premium businesses verified by our team\",\"status\":\"1\",\"limit\":\"6\"}', NULL, 'basic', '', NOW(), NOW()),
(557, 'marketplace_popular.content', '{\"heading\":\"Most Popular\",\"subheading\":\"Trending businesses with the highest engagement\",\"status\":\"1\",\"limit\":\"6\"}', NULL, 'basic', '', NOW(), NOW()),
(558, 'marketplace_new.content', '{\"heading\":\"Just Listed\",\"subheading\":\"Fresh opportunities just added to the marketplace\",\"status\":\"1\",\"limit\":\"6\"}', NULL, 'basic', '', NOW(), NOW()),
(559, 'marketplace_ending.content', '{\"heading\":\"Auctions Ending Soon\",\"subheading\":\"Hurry! These auctions are closing soon\",\"status\":\"1\",\"limit\":\"6\"}', NULL, 'basic', '', NOW(), NOW()),
(560, 'marketplace_domains.content', '{\"heading\":\"Premium Domains\",\"subheading\":\"High-value domain names for your next project\",\"status\":\"1\",\"limit\":\"4\"}', NULL, 'basic', '', NOW(), NOW()),
(561, 'marketplace_websites.content', '{\"heading\":\"Profitable Websites\",\"subheading\":\"Revenue-generating websites ready for acquisition\",\"status\":\"1\",\"limit\":\"4\"}', NULL, 'basic', '', NOW(), NOW()),
(562, 'marketplace_apps.content', '{\"heading\":\"Mobile & Desktop Apps\",\"subheading\":\"Established applications with active user bases\",\"status\":\"1\",\"limit\":\"4\"}', NULL, 'basic', '', NOW(), NOW()),
(563, 'marketplace_social.content', '{\"heading\":\"Social Media Accounts\",\"subheading\":\"Built-in audiences ready for monetization\",\"status\":\"1\",\"limit\":\"4\"}', NULL, 'basic', '', NOW(), NOW()),
(564, 'marketplace_stats.content', '{\"heading\":\"Marketplace Statistics\",\"status\":\"1\",\"show_total_listings\":\"1\",\"show_total_sold\":\"1\",\"show_total_value\":\"1\",\"show_active_users\":\"1\"}', NULL, 'basic', '', NOW(), NOW()),
(565, 'marketplace_cta.content', '{\"heading\":\"Ready to Sell Your Business?\",\"subheading\":\"List your online business and reach thousands of qualified buyers\",\"button_text\":\"Start Selling\",\"button_url\":\"/user/listing/create\",\"status\":\"1\"}', NULL, 'basic', '', NOW(), NOW());
...
(1, 'allow_auctions', '1', NOW(), NOW()),
(2, 'allow_fixed_price', '1', NOW(), NOW()),
(3, 'allow_domain_listings', '1', NOW(), NOW()),
(4, 'allow_website_listings', '1', NOW(), NOW()),
(5, 'allow_social_media_listings', '1', NOW(), NOW()),
(6, 'allow_mobile_app_listings', '1', NOW(), NOW()),
(7, 'allow_desktop_app_listings', '1', NOW(), NOW()),
(8, 'max_auction_days', '30', NOW(), NOW()),
(9, 'min_auction_days', '1', NOW(), NOW()),
(10, 'require_domain_verification', '1', NOW(), NOW()),
(11, 'require_website_verification', '1', NOW(), NOW()),
(12, 'domain_verification_methods', '["txt_file","dns_record"]', NOW(), NOW()),
(13, 'listing_approval_required', '1', NOW(), NOW()),
(14, 'max_images_per_listing', '10', NOW(), NOW()),
(15, 'min_listing_description', '100', NOW(), NOW()),
(16, 'featured_listing_fee', '0', NOW(), NOW()),
(17, 'listing_fee_percentage', '0', NOW(), NOW()),
(18, 'escrow_fee_percentage', '5', NOW(), NOW()),
(19, 'auto_extend_auction_minutes', '10', NOW(), NOW()),
(20, 'bid_extension_threshold_minutes', '5', NOW(), NOW());
...
--
INSERT INTO `listing_categories` (`name`, `slug`, `icon`, `description`, `business_type`, `parent_id`, `status`, `sort_order`, `created_at`, `updated_at`) VALUES
('Premium Domains', 'premium-domains', 'las la-globe', 'High-value domain names', 'domain', 0, 1, 1, NOW(), NOW()),
('Brandable Domains', 'brandable-domains', 'las la-tag', 'Short, memorable domain names', 'domain', 0, 1, 2, NOW(), NOW()),
('Keyword Domains', 'keyword-domains', 'las la-key', 'SEO-friendly keyword domains', 'domain', 0, 1, 3, NOW(), NOW()),
('E-commerce Websites', 'ecommerce-websites', 'las la-shopping-cart', 'Online stores and shops', 'website', 0, 1, 4, NOW(), NOW()),
('Content Websites', 'content-websites', 'las la-newspaper', 'Blogs and content sites', 'website', 0, 1, 5, NOW(), NOW()),
('SaaS Businesses', 'saas-businesses', 'las la-cloud', 'Software as a Service', 'website', 0, 1, 6, NOW(), NOW()),
('Affiliate Websites', 'affiliate-websites', 'las la-link', 'Affiliate marketing sites', 'website', 0, 1, 7, NOW(), NOW()),
('Instagram Accounts', 'instagram-accounts', 'lab la-instagram', 'Instagram social media accounts', 'social_media_account', 0, 1, 8, NOW(), NOW()),
('YouTube Channels', 'youtube-channels', 'lab la-youtube', 'YouTube channels', 'social_media_account', 0, 1, 9, NOW(), NOW()),
('TikTok Accounts', 'tiktok-accounts', 'lab la-tiktok', 'TikTok social media accounts', 'social_media_account', 0, 1, 10, NOW(), NOW()),
('Twitter/X Accounts', 'twitter-accounts', 'lab la-twitter', 'Twitter/X social media accounts', 'social_media_account', 0, 1, 11, NOW(), NOW()),
('iOS Apps', 'ios-apps', 'lab la-apple', 'iPhone and iPad applications', 'mobile_app', 0, 1, 12, NOW(), NOW()),
('Android Apps', 'android-apps', 'lab la-android', 'Android applications', 'mobile_app', 0, 1, 13, NOW(), NOW()),
('Cross-Platform Apps', 'cross-platform-apps', 'las la-mobile-alt', 'iOS and Android apps', 'mobile_app', 0, 1, 14, NOW(), NOW()),
('Windows Apps', 'windows-apps', 'lab la-windows', 'Windows desktop applications', 'desktop_app', 0, 1, 15, NOW(), NOW()),
('Mac Apps', 'mac-apps', 'lab la-apple', 'macOS desktop applications', 'desktop_app', 0, 1, 16, NOW(), NOW()),
('Cross-Platform Desktop', 'cross-platform-desktop', 'las la-desktop', 'Multi-platform desktop apps', 'desktop_app', 0, 1, 17, NOW(), NOW());
